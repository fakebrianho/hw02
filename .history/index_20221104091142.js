...
const setupButtons = () => {
	const increaseScore = document.querySelector('#button1')
	const decreaseScore = document.querySelector('#button2')
	increaseScore.addEventListener('click', handleScore)
	decreaseScore.addEventListener('click', handleScore)
}
